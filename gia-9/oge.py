...
# + и - будут переведены в 1 и 0 и расставлены отдельно в ячейки
...
if __name__=='__main__':
    print('''
            Данная прога обрабатывает excel файлы с расширением xlsx
             + и - будут переведены в 1 и 0 и расставлены отдельно по ячейкам.
             Также программа может выдавать статистику по оценкам
    
                Для продолжнения работы выбирите нужное вам действие
                    1 - сформировать новые листы в каждом файле с результатами
                    2 - сформировать данные в отдельные листы одного общего файла (листы будут названы по школам)
